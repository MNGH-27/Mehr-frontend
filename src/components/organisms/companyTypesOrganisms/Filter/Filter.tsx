...
import { AddCompanySystemTypeModal } from './resources'

const CompanyTypesFilter = () => {
    ...
    return (
        <div className='flex flex-col lg:flex-row items-start justify-center gap-x-10 gap-y-3'>
            ...
            <SModal
                ...
                topSection={{
                    title: 'ایجاد دسته‌بندی شرکت',
                    description: 'مشخصات دسته‌بندی شرکت جدید را وارد کنید:'
                }}
            >
                <AddCompanySystemTypeModal onClose={onCloseAddModal} />
            </SModal>
        </div>
    )
}

export default CompanyTypesFilter
