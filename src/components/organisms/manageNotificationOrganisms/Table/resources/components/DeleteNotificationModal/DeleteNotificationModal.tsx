...
import { postDeleteNewsMutationFn } from '@core/services/api/news/post-delete-news'
import { type TCriticalAny } from '@core/types/type-any'

import { type IDeleteNotificationModalProps } from './resources'

const DeleteNotificationModal: FC<IDeleteNotificationModalProps> = ({ onClose, data }) => {
    const queryClient = useQueryClient()

    const { mutate, isPending } = useMutation({
        mutationFn: postDeleteNewsMutationFn,
