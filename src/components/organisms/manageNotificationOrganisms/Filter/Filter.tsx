...
import { AddNotificationModal } from './resources'

const ManageNotificationFilter = () => {
    ...
    return (
        <div className='flex flex-col lg:flex-row items-start justify-center gap-x-10 gap-y-3'>
            ...
            <SModal
                ...
                topSection={{
                    title: 'ایجاد اعلان',
                    description: 'مشخصات اعلان جدید را وارد کنید:'
                }}
            >
                <AddNotificationModal onClose={onCloseAddModal} />
            </SModal>
        </div>
    )
}

export default ManageNotificationFilter
