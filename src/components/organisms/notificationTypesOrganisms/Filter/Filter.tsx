...
import { AddNotificationSystemTypeModal } from './resources'
    ...
    return (
        <div className='flex flex-col lg:flex-row items-start justify-center gap-x-10 gap-y-3'>
            ...
            <SModal
                ...
                topSection={{
                    title: 'ایجاد دسته‌بندی اعلان',
                    description: 'مشخصات دسته‌بندی اعلان جدید را وارد کنید:'
                }}
            >
                <AddNotificationSystemTypeModal onClose={onCloseAddModal} />
            </SModal>
        </div>
    )
}
