...
const DetailReportModal: FC<IDetailReportModalProps> = ({ data }) => {
    ...
    return (
        <div className='grid md:grid-cols-2 gap-5'>
            ...
            <div className='flex items-center justify-start gap-1 flex-wrap'>
                <span className='text-secondary-800'>محدودیت زمانی</span>
                <span className='text-primary font-medium'>{data?.dayLimit}</span>
            </div>
            <div className='flex items-center justify-start gap-1 flex-wrap'>
            ...
            <div className='flex items-center justify-start gap-1 flex-wrap'>
                <span className='text-secondary-800'>بازه زمانی گزارش</span>
                <span className='text-primary font-medium'>{data?.titleTimePeriod}</span>
            </div>
            {data?.documentId && (
                <>
                    ...
                    <div className='flex items-center justify-start gap-1 flex-wrap'>
                        ...
                        <span className='text-primary font-medium'>{data?.documentFormatName}</span>
                    </div>
                    <div className='flex items-center justify-start gap-1 flex-wrap'>
